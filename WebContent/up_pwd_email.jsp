	...
	<div style="width:1200px; margin:auto;">
        ...
        <div class="middle">
        	<div style="width:880px; height:380px; margin:auto; margin-top:38px;">
                ...
                <!--2.验证邮箱/手机--> 
                <div class="middle_changePwd" id="chackEM">
                    ...
                    <div style="height:220px; color:#060;">
                        <br />
                        <br />
                        <form action="up_pwd_pwd.jsp" method="post" name="EmailForm" onsubmit="return checkEail()">
                            <div style="text-align:left; margin-left:285px; color:#333;">
                            	邮箱/手机：<input type="text" id="mail" name="mail" placeholder="请输入邮箱"/>
