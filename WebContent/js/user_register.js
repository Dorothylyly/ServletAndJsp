...
function checkLogin1(){
	...
	document.getElementById("phoneregister").style.borderBottomColor = "#C00";
...
function checkLogin2(){
	...
	document.getElementById("emailregister").style.borderBottomColor = "#C00";
...
function checkbox(){
	...
	if(!checkbox){
		...
		document.getElementById("submit").style.background = "#C33";
...
function checkboxEMail(){
	...
	if(!checkbox){
		...
		document.getElementById("submit2").style.background = "#C33";
