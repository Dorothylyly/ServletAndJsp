...
public class UserServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        { // 查所有用户
            ...
            request.getRequestDispatcher("backstage/manager_user_list.jsp").forward(request,
                                                                                    response);
            return;
        }
        else
            ...
            { // 查看详情
                ...
                request.getRequestDispatcher("backstage/manager_user_details.jsp")
                ...
                { // 添加用户
                    ...
                    nUser.setVip(request.getParameter("type"));

                    if(um.queryUser(nUser))
                    {
                        request.setAttribute("errmsg", "账号已存在");
                        request.getRequestDispatcher("backstage/manager_user_add.jsp")
                               .forward(request, response);
                        return;
                    }
                    ...
                    { // 删除用户
                        ...
                        if(!um.deleteUser(dUser))
                        {
                            ...
                            request.getRequestDispatcher("backstage/manager_user_del.jsp")
                                   .forward(request, response);
                            return;
                        }
